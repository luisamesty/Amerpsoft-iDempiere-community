...
| ----: | -------------------------------------------------------------------------------- | ----------------- | --------------------------------------------------------------- |
|     1 | [Install PostgreSQL 15](#1-Install-PostgreSQL-15)                                 | Dabase machine    | Install postgresql from Ubuntu distribution. Update repository. |
|     2 | [Config PostgreSQL 15 ](#ConfigPostgreSQL)                                   | Database machine  | Edit pg_hba.conf / postgresql.conf files                        |
|     3 | [Install JAVA OpenJDK17 ](#Install_JAVA_OpenJDK17)                           | Idempiere machine | Download and install Java 17                                    |
|     4 | [Download Installers ](#Download_idempiere11_Installers)                     | Idempiere machine | Download installers from iDempiere repository                   |
|     5 | [Install idempiere11 from Installers ](#Install_IDEMPIERE11_From_Installers) | Idempiere machine | Unzip and copy Installers in /opt directory    |
|     6 | [Running idempiere11 ](#Running_IDEMPIERE11)      | Idempiere machine | Run Configure auto execute idempiere                            |

### 1-⭐️Install PostgreSQL 15
...
### 5-⭐️Install idempiere11 from Installers

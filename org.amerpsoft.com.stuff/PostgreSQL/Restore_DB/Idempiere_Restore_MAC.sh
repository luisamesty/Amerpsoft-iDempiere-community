...
PGPASSFILE=/Volumes/Datos/Backup_PG10.5/.pgpass
# PostgreSQL Home Binaries
# FOR MAC OS
PGHOME=/Library/PostgreSQL/10/bin/
# FOR LINUX PostgreSQL 10
#PGHOME=/usr/lib/postgresql/10/bin/psql/
# PATH
PATH=$PGHOME:$PATH
...
# Ends with '/'
RESTOREDIR="/Volumes/Datos/Backup_PG10.5/BackupPG/"
...
if psql -U $USERNAME $HOST -d postgres -lqt | cut -d \| -f 1 | grep -qw "$DBNAME";then
    echo "****** WARNING ******************************"

...
.desktop-left-column .z-panel-icon {
    ...
    background: linear-gradient(to bottom,#63666A 0,#63666A 100%);
    text-align: center;
    overflow: hidden;
    cursor: pointer;
    float: right;
...
.desktop-tabbox .z-tab::before {
    ...
    background: linear-gradient(to bottom, #fff 15%,#fff 30%,#fff 100%) filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#f0f9ff', endColorstr='#9db7db',GradientType=0 );

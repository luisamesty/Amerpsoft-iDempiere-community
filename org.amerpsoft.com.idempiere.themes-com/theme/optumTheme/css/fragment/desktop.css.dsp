...
.desktop-tabbox .z-tab-selected .z-tab-text {
    ...
    background: linear-gradient(to bottom, #ffffff,#ffffff,#ffffff 100%);
...
.desktop-tabbox .z-tab-selected .z-tab-button {
    ...
    background: #7abcff;
    background: -moz-linear-gradient(top, #7abcff 0%, #60abf8 44%, #4096ee 100%);
    background: -webkit-linear-gradient(top, #fff 0%,#fff 44%,#fff 100%);
    background: linear-gradient(to bottom, #fff 30%,#fff 20%,#fff 100%);
    filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#7abcff', endColorstr='#4096ee',GradientType=0 );
}
...
.desktop-tabbox .z-tab {
    padding-top: 0px;
    background: #fff;
    background: -moz-linear-gradient(top, #fff 15%, #fff 30%, #fff 100%);
    background: -webkit-linear-gradient(top, #fff 15%,#fff 30%,#fff 100%);
    background: linear-gradient(to bottom, #fff 15%,#fff 30%,#fff 100%)

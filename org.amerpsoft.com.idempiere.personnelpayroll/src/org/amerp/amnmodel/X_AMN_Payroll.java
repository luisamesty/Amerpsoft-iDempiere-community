...
@org.adempiere.base.Model(table="AMN_Payroll")
...
// N
    ...
    /** Standard Constructor */
    public X_AMN_Payroll (Properties ctx, int AMN_Payroll_ID, String trxName, String ... virtualColumns)
    {
      super (ctx, AMN_Payroll_ID, trxName, virtualColumns);
      /** if (AMN_Payroll_ID == 0)
        {
			setAMN_Contract_ID (0);
			setAMN_Department_ID (0);
...
// N
    ...
    /** Standard Constructor */
    public X_AMN_Payroll (Properties ctx, String AMN_Payroll_UU, String trxName)
    {
      super (ctx, AMN_Payroll_UU, trxName);
      /** if (AMN_Payroll_UU == null)
        {
			setAMN_Contract_ID (0);
			setAMN_Department_ID (0);
			setAMN_Employee_ID (0);
...
// N
    ...
    /** Standard Constructor */
    public X_AMN_Payroll (Properties ctx, String AMN_Payroll_UU, String trxName, String ... virtualColumns)
    {
      super (ctx, AMN_Payroll_UU, trxName, virtualColumns);
      /** if (AMN_Payroll_UU == null)
        {
			setAMN_Contract_ID (0);
			setAMN_Department_ID (0);
...
// N
    ...
    {
      StringBuilder sb = new StringBuilder ("X_AMN_Payroll[")
	...
	*/
	...
	{
		return (I_AMN_Payroll_Lot)MTable.get(getCtx(), I_AMN_Payroll_Lot.Table_ID)
	...
	*/
	...
	/** Set RefDateEnd.
		@param RefDateEnd End Reference Date
	*/
	...
	/** Set RefDateIni.
		@param RefDateIni Initial Reference Date
	*/

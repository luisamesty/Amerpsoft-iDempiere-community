...
@org.adempiere.base.Model(table="AMN_Payroll_Assist")
...
// N
    ...
    /** Standard Constructor */
    public X_AMN_Payroll_Assist (Properties ctx, int AMN_Payroll_Assist_ID, String trxName, String ... virtualColumns)
    {
      super (ctx, AMN_Payroll_Assist_ID, trxName, virtualColumns);
      /** if (AMN_Payroll_Assist_ID == 0)
        {
			setAMN_AssistRecord (null);
			setAMN_Employee_ID (0);
...
// N
    ...
    /** Standard Constructor */
    public X_AMN_Payroll_Assist (Properties ctx, String AMN_Payroll_Assist_UU, String trxName)
    {
      super (ctx, AMN_Payroll_Assist_UU, trxName);
      /** if (AMN_Payroll_Assist_UU == null)
        {
			setAMN_AssistRecord (null);
			setAMN_Employee_ID (0);
// @AMN_Employee_ID@
...
// N
    ...
    /** Standard Constructor */
    public X_AMN_Payroll_Assist (Properties ctx, String AMN_Payroll_Assist_UU, String trxName, String ... virtualColumns)
    {
      super (ctx, AMN_Payroll_Assist_UU, trxName, virtualColumns);
      /** if (AMN_Payroll_Assist_UU == null)
        {
			setAMN_AssistRecord (null);
			setAMN_Employee_ID (0);
...
// N
    ...
    {
      StringBuilder sb = new StringBuilder ("X_AMN_Payroll_Assist[")
	...
	*/
	...
	/** Set Payroll Assist .
		@param AMN_Payroll_Assist_ID Payroll Attendance 
	*/
	...
	*/
	...
	/** Set AMN_Payroll_Assist_UU.
		@param AMN_Payroll_Assist_UU Payroll Attendance UU
	*/

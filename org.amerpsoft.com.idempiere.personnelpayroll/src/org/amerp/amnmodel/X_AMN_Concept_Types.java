...
@org.adempiere.base.Model(table="AMN_Concept_Types")
...
// N
    ...
    /** Standard Constructor */
    public X_AMN_Concept_Types (Properties ctx, int AMN_Concept_Types_ID, String trxName, String ... virtualColumns)
    {
      super (ctx, AMN_Concept_Types_ID, trxName, virtualColumns);
      /** if (AMN_Concept_Types_ID == 0)
        {
			setAMN_Concept_ID (0);
// @AMN_Concept_ID@
...
// N
    ...
    /** Standard Constructor */
    public X_AMN_Concept_Types (Properties ctx, String AMN_Concept_Types_UU, String trxName)
    {
      super (ctx, AMN_Concept_Types_UU, trxName);
      /** if (AMN_Concept_Types_UU == null)
        {
			setAMN_Concept_ID (0);
// @AMN_Concept_ID@
			setAMN_Concept_Types_ID (0);
...
// N
    ...
    /** Standard Constructor */
    public X_AMN_Concept_Types (Properties ctx, String AMN_Concept_Types_UU, String trxName, String ... virtualColumns)
    {
      super (ctx, AMN_Concept_Types_UU, trxName, virtualColumns);
      /** if (AMN_Concept_Types_UU == null)
        {
			setAMN_Concept_ID (0);
// @AMN_Concept_ID@
...
// N
    ...
    {
      StringBuilder sb = new StringBuilder ("X_AMN_Concept_Types[")
	...
	{
		return (I_AMN_Concept)MTable.get(getCtx(), I_AMN_Concept.Table_ID)
			.getPO(getAMN_Concept_ID(), get_TrxName());
	}
	...
	*/
	...
	/** Set Concept Credit Administrative Work Force Account.
		@param AMN_Cre_Acct Concept Credit Administrative Work Force Account
	*/
	...
	/** Set Concept Credit Direct Work Force Account.
		@param AMN_Cre_DW_Acct Concept Credit Direct Work Force Account
	*/
	...
	/** Set Concept Credit Indirect Work Force Account.
		@param AMN_Cre_IW_Acct Concept Credit Indirect Work Force Account
	*/
	...
	/** Set Concept Credit Management Work Force Account.
		@param AMN_Cre_MW_Acct Concept Credit Management Work Force Account
	*/
	...
	/** Set Concept Credit Sales Work Force Account.
		@param AMN_Cre_SW_Acct Concept Credit Sales Work Force Account
	*/
	...
	/** Set Payroll Concept Type Credit Account.
		@param AMN_CT_Cre_Acct_ID Payroll Concept Type Credit Account
	*/
	...
	/** Set Payroll Concept Type Debit Account.
		@param AMN_CT_Deb_Acct_ID Payroll Concept Type Debit Account
	*/
	...
	/** Set Concept Debit Administrative Work Force  Account.
		@param AMN_Deb_Acct Concept Debit Administrative Work Force  Account
	*/
	...
	/** Set Concept Debit Direct Work Force Account.
		@param AMN_Deb_DW_Acct Concept Debit Direct Work Force Debit Account
	*/
	...
	/** Set Concept Debit Indirect Work Force Account.
		@param AMN_Deb_IW_Acct Concept Debit Indirect Work Force Debit Account
	*/
	...
	/** Set Concept Debit Management Work Force Account.
		@param AMN_Deb_MW_Acct Concept Debit Management Work Force Debit Account
	*/
	...
	/** Set Concept Debit Sales Work Force Account.
		@param AMN_Deb_SW_Acct Concept Debit Sales Work Force  Debit Account
	*/
	...
	*/
	...
	/** Set Concept Source.
		@param conceptsource Origen or Source for Concept Type
	*/
	...
	*/
	...
	/** Set Holiday.
		@param feriado Indicates id Apllies for Holidays Calc
	*/
	...
	*/
	...
	/** Set ScriptDefaultValue.
		@param ScriptDefaultValue Dynamic Java Language Script to calculate result for Default Value  (alternative to DefaultValue)
	*/

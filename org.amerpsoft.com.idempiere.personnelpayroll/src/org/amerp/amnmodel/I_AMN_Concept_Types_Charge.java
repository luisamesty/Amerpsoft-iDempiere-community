...
/** Generated Interface for AMN_Concept_Types_Charge
 *  @author iDempiere (generated) 
 *  @version Release 11
 */
@SuppressWarnings("all")
public interface I_AMN_Concept_Types_Charge 
{

    /** TableName=AMN_Concept_Types_Charge */
    public static final String Table_Name = "AMN_Concept_Types_Charge";
    ...
    /** Column name AMN_Concept_Types_Charge_ID */
    public static final String COLUMNNAME_AMN_Concept_Types_Charge_ID = "AMN_Concept_Types_Charge_ID";

	/** Set Payroll  Concept Types Charges.
	  * Charges for AMN_Concept_Types
	  */
    ...
    /** Column name AMN_Concept_Types_Charge_UU */
    public static final String COLUMNNAME_AMN_Concept_Types_Charge_UU = "AMN_Concept_Types_Charge_UU";

-- DROP FUNCTION adempiere.amf_dow2letter(bpchar, bpchar, bpchar);

CREATE OR REPLACE FUNCTION adempiere.amf_dow2letter(conv_dow numeric, upp_low character, languaje_iso character)

-- Payroll Social Security MTESS UTilities (Aguinaldos)
-- PayrollSocialSecurityMTESSUtilities
--
SELECT * FROM
(
	-- REPORT HEADER
...
(
    ...
    -- LOCATION
	   lct.amn_location_id, lct.value as loc_value,
	   lct.socialsecurityid, lct.socialsecuritymtess, 
    -- CONTRACT
       amc.amn_contract_id,
...
ORDER BY sso.c_value, sso.emp_value

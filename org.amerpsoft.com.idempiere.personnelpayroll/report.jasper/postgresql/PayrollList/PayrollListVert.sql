...
FULL JOIN
	...
	COALESCE(currt2.description,curr2.iso_code,curr2.cursymbol,'') as currname2,
	 -- EMPLOYEE
	 emp.amn_employee_id, emp.value as value_emp, 
  ...
  INNER JOIN adempiere.amn_employee as emp ON ((emp.amn_employee_id= pyr.amn_employee_id) AND (emp.isactive= 'Y'))
...
ORDER BY nomina.org_value, nomina.amn_period_id, nomina.loc_value, nomina.dpto_value,  nomina.value_emp ASC, nomina.amn_payroll_id ASC,  nomina.calcorder,nomina.isshow DESC, header_info ASC

...
public class LCO_ModelFactoryWH implements IModelFactory {
	...
	public Class<?> getClass(String tableName) {
		...
		// Two New Tables 
		if (MLCOInvoiceWHDoc.Table_Name.equals(tableName))
			return MLCOInvoiceWHDoc.class;
		if (MLCOInvoiceWHDocLines.Table_Name.equals(tableName))
			return MLCOInvoiceWHDocLines.class;
		return null;
	}
	...
	public PO getPO(String tableName, int Record_ID, String trxName) {
		...
		// Two New Tables 
		if (MLCOInvoiceWHDoc.Table_Name.equals(tableName))
			return new MLCOInvoiceWHDoc(Env.getCtx(), Record_ID, trxName);
		if (MLCOInvoiceWHDocLines.Table_Name.equals(tableName))
			return new MLCOInvoiceWHDocLines(Env.getCtx(), Record_ID, trxName);
		return null;
	}
	...
	public PO getPO(String tableName, ResultSet rs, String trxName) {
		...
		// Two New Tables 
		if (MLCOInvoiceWHDoc.Table_Name.equals(tableName))
			return new MLCOInvoiceWHDoc(Env.getCtx(), rs, trxName);
		if (MLCOInvoiceWHDocLines.Table_Name.equals(tableName))
			return new MLCOInvoiceWHDocLines(Env.getCtx(), rs, trxName);
		return null;
	}

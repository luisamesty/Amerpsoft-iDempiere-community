-- TrialBalanceTwoDates_TreeOrg V1
-- TrialBalance_Tree V8
-- OrgTree Version4
...
LEFT JOIN (	
	...
	SELECT
		...
		LEFT JOIN (
			...
			WHERE fas.DateAcct <= per02.EndDate
			AND fas.ad_client_id=$P{AD_Client_ID}
			GROUP BY fas.ad_client_id, fas.ad_org_id, fas.account_id, fas.C_AcctSchema_ID

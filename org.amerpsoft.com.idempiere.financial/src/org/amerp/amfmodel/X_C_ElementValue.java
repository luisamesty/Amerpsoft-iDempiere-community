...
// Y
	...
	/** Set C_Elementparent_ID.
		@param C_Elementparent_ID C_Elementparent_ID	  */
	public void setC_Elementparent_ID (int C_Elementparent_ID)
	{
		if (C_Elementparent_ID < 1) 
			set_Value (COLUMNNAME_C_Elementparent_ID, null);
		else 
			set_Value (COLUMNNAME_C_Elementparent_ID, Integer.valueOf(C_Elementparent_ID));
	}

	/** Get C_Elementparent_ID.
		@return C_Elementparent_ID	  */
	public int getC_Elementparent_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_C_Elementparent_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
	...
	/** Set Value Parent.
		@param Value_Parent Value Parent	  */

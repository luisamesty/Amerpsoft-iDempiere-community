...
public interface I_C_TaxCategory 
{
    ...
    /** Column name withholdingformat */
    public static final String COLUMNNAME_withholdingformat = "withholdingformat";

	/** Set Withholding Format.
	  * Indicates type of Withholding Format applied to Withholding Transaction
	  */

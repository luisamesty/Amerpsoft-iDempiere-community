-- Function: adempiere.amf_acctdate3balance(numeric, numeric, numeric, timestamp without time zone, timestamp without time zone)
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION adempiere.amf_acctdate3balance(numeric, numeric, numeric, timestamp without time zone, timestamp without time zone)
  OWNER TO adempiere;

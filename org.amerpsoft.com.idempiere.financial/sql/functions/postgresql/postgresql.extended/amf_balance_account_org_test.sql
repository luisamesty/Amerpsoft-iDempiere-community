...
select
	...
	eve.codigo, eve.name, eve.description, eve.length, eve.accounttype, eve.accountsign,
...
as bal on bal.bal_c_elementvalue_id = eve.c_elementvalue_id and bal.ad_org_id = org.org_ad_org_id

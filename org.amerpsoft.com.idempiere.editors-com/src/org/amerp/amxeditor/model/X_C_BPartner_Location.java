...
// .
	...
	/** Set Address Extended.
		@param C_LocationExtended_ID 
		Location or Address Extended
	  */
	public void setC_LocationExtended_ID (Object C_LocationExtended_ID)
	{
		set_Value (COLUMNNAME_C_LocationExtended_ID, C_LocationExtended_ID);
	}

	/** Get Address Extended.
		@return Location or Address Extended
	  */
	public Object getC_LocationExtended_ID () 
	{
				return get_Value(COLUMNNAME_C_LocationExtended_ID);
	}
